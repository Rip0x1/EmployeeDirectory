...
namespace EmployeeDirectory.Pages.Departments
{
    ...
    public class CreateModel : PageModel
    {
        ...
        public CreateModel(IDepartmentService departmentService, IEmployeeService employeeService, UserManager<ApplicationUser> userManager, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (!string.IsNullOrEmpty(referer) && !referer.Contains("/Departments/Create"))
            {
